...
/**
 * Falls back to initials if the photo is missing or fails to load, so an absent
 * file degrades to a designed state instead of the broken-image icon the old
 * hotlinked LinkedIn URLs left on the page for two years after they expired.
 */
