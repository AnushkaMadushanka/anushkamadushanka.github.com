			...
			sections: [
				{
					...
					body: [
						...
						"Both sides of that are the same product. The agent needs a listing to be shareable before it's public, and the buyer needs to find it — so the interesting work sits in the middle, in what a listing is allowed to be before it officially exists.",
					],
				},
				{
			...
			gallery: [
				{
					...
					alt: "The Uplist feed — a pre-market property in Pymble with photos, bed, bath and car counts, price on application, and the listing agent",
				},
				{
				...
				},
				{
					...
					alt: "Map search — properties plotted across a suburb with a contact-agent card for the selected listing",
				},
				{
					src: "/work/uplist/notifications.webp",
					alt: "The notifications screen — alerts for updated properties and new listings in followed suburbs",
				},
			],
		},
	},
			...
			sections: [
				{
					...
					body: [
						...
						"The insight was that the browser already knows which products are on screen. If the recorder lives in the tab, it can capture the products as it goes.",
					],
				},
				{
				...
				},
				{
					...
					body: [
						"Chrome extensions have no hot reload. Every change meant waiting for webpack, switching to chrome://extensions, clicking reload, switching back — dozens of times an hour, with no signal about whether the build you were testing was even finished.",
			...
			sections: [
				{
					...
					body: [
						...
						"Shopcast is a widget a merchant installs from the Shopify App Store. It puts a button on the product page, and the button opens a video that plays in place — the shopper never leaves the page they were about to buy from.",
					],
				},
				{
					heading: "Built for merchants, not for us",
					body: [
						"A widget that looks like someone else's product on your storefront doesn't get installed twice. So the configuration is the feature: merchants set the button label, the player theme colour, the background and where the player opens from, and preview each change against their own storefront before publishing.",
