 ...
 *
 * Counted inclusively of both the start and end month, which is how LinkedIn
 * and the CV present these — Sep 2017 to Jan 2021 reads as "3 yrs 5 mos", not
 * "3 yrs 4 mos". Keeping the same convention means the site and the PDF agree.
 */
...
export const profile = {
	...
	/** The one-line pitch. Specific beats generic. */
	tagline:
