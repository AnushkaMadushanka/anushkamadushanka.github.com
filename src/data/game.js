	...
	caseStudy: {
		...
		sections: [
			...
			},
			{
				...
				body: [
					"The run map is a Slay-the-Spire-style layered DAG. Rather than serialising the graph, I persist only the seed plus the visited path — regenerating from the seed always reproduces an identical graph. The whole run state is a couple of strings.",
			...
			{
				heading: "The table is the UI",
				body: [
					"There is almost no conventional interface. The wager panel is a contract on the table, the shop is cards laid out in front of you, and settings are the only real canvas in the game. Matches literally conjure their space: props and both Kings dissolve in once a stake is locked, and dissolve out when a King dies, leaving an empty table for a beat before the result.",
			...
			},
			{
				...
				body: [
					"Menu, run map, matches and all four rest stops live in one scene — nothing loads or unloads. Singletons and cross-references stay valid throughout, which removed an entire category of lifecycle bugs and made transitions instant.",
			...
			},
			{
				...
				body: [
					...
					"There is no “wager nothing”. A minimum stake is always enforced — a card game you can play risk-free isn't about temptation, and temptation is the entire point.",
		...
		gallery: [
			...
			{
				src: `${SHOTS}/shop.webp`,
				alt: "The shop — ten cards laid out across the table, each priced in lifespan",
			},
			{
			...
			},
			{
				...
				alt: "Card removal — the whole deck fanned out across the table, up to three cards selectable to burn",
			},
		],

		note: {
			label: "Source",
			text: "Private repository — the game is in active development. Happy to walk through the code in an interview.",
		},
