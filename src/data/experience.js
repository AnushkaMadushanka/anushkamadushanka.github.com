 ...
 * the site can't drift out of date again.
 */
export const experience = [
	...
	},
	{
		...
		highlights: [
			...
			"Rebuilt billing from one flat product into four paid tiers with team accounts — 412 paying subscribers and $9k MRR across US, UK and APAC at 1.29% monthly churn.",
	...
	},
	{
		...
		highlights: [
			"Led a hospital communication platform with live intra-hospital video conferencing, built in React Native.",
			"Built a Unity 3D indoor navigation system for retail stores.",
			"Built an e-commerce storefront with Stripe and Firebase.",
		],
