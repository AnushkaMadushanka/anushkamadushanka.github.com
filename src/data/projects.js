...
export const projects = [
	...
	},
	{
		name: "Ludo Shooter",
		blurb:
			"A wave shooter where reloading rolls a dice — and whatever face it lands on rewrites the rules of the fight.",
	...
	},
	{
		...
		blurb:
			"Top-down zombie shooter set in a maze that's different every time — Hunt-and-Kill generation with NavMesh-driven AI.",
	...
	},
	{
		...
		blurb:
			"Two real-time music visualisers in Unity — an FFT spectrum split into logarithmic bands driving geometry and light.",
